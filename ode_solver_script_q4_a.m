function Out= ode_solver_script_q4_a(t,x)

%% Input parameters
m2=1; m1=1; l1=1; l2=1; g=9.81;

tau1=(-3.474e-05)*t.^6 + (0.0008649 )*t.^5 + (-0.004596)*t.^4 + (-0.01598  )*t.^3 + ( 0.03615)*t.^2 + (-0.0571 )*t +19.76; %Input torque for planned trajectory
tau2=0; %Torque 2 is zero
