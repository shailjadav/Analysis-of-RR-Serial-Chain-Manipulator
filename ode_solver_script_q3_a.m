function Out= ode_solver_script_q3_a(t,x)
...
tau2=(-2.676e-05 )*t.^6 + (0.0006413 )*t.^5 + (-0.003133)*t.^4 + (-0.01392  )*t.^3 + ( 0.03229  )*t.^2 + (-0.03644 )*t +4.956; %second torque is the same as torque 1
