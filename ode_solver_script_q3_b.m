function Out= ode_solver_script_q3_b(t,x)

%% Input parameters
m2=2; m1=1; l1=1; l2=1; g=9.81;

tau1=(-6.672e-05)*t.^6 + (0.001649 )*t.^5 + (-0.00861 )*t.^4 + ( -0.0318 )*t.^3 + ( 0.07193)*t.^2 + (-0.1118  )*t +  34.6 ; %Input torque is zero
tau2=(-5.353e-05 )*t.^6 + (0.001283  )*t.^5 + (-0.006265 )*t.^4 + (-0.02784  )*t.^3 + (  0.06457 )*t.^2 + ( -0.07288 )*t +9.912  ; %second torque is the same as torque 1
